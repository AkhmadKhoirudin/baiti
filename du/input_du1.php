...
<div class="container mt-5">
    <h3> Data Daftar Ulang (Pemasukan/Pengeluaran)</h3>
    <?php echo $msg; ?>
    <form method="post">
        <div class="mb-3">
            ...
            <select class="form-select" id="tipe" name="tipe" required>
                ...
                <option value="pemasukan">Pemasukan Daftar Ulang</option>
                <option value="pengeluaran">Pengeluaran Daftar ulang</option>
            </select>
        </div>
        <div class="mb-3">
