...
$q_total_bulan = $conn->query("
    SELECT
        ...
        SUM(CASE WHEN siswa_nik IS NOT NULL AND siswa_nik<>'' AND tahun_ajaran IS NOT NULL AND tahun_ajaran<>'' THEN nominal ELSE 0 END) as total_pemasukan,
        SUM(CASE WHEN status='pengeluaran' THEN nominal ELSE 0 END) as total_pengeluaran,
        (SUM(CASE WHEN siswa_nik IS NOT NULL AND siswa_nik<>'' AND tahun_ajaran IS NOT NULL AND tahun_ajaran<>'' THEN nominal ELSE 0 END) -
...
$q_total_keseluruhan = $conn->query("
    SELECT
        SUM(CASE WHEN siswa_nik IS NOT NULL AND siswa_nik<>'' AND tahun_ajaran IS NOT NULL AND tahun_ajaran<>'' THEN nominal ELSE 0 END) as total_pemasukan_all,
...
$q_bulan_ini = $conn->query("
    SELECT
        SUM(CASE WHEN siswa_nik IS NOT NULL AND siswa_nik<>'' AND tahun_ajaran IS NOT NULL AND tahun_ajaran<>'' THEN nominal ELSE 0 END) as pemasukan_bulan_ini,
...
$q_pemasukan = $conn->query("SELECT du.*, siswa.nama as nama_siswa
    ...
    WHERE du.siswa_nik IS NOT NULL AND du.siswa_nik<>'' AND du.tahun_ajaran IS NOT NULL AND du.tahun_ajaran<>''
...
<head>
  <meta charset="UTF-8">
  <title>Laporan Keuangan DB</title>
...
<div class="container-fluid py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 text-primary">
      <i class="bi bi-graph-up"></i> Laporan Keuangan DB
    </h1>
    <div class="btn-group">
